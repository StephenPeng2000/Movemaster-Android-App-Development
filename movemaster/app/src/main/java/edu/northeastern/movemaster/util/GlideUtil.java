...
public class GlideUtil {
    public static void load(ImageView view, String path) {
        Glide.with(view).load(path).error(R.drawable.ic_logo).into(view);
    }    public static void load(ImageView view, int path) {
        Glide.with(view).load(path).error(R.drawable.ic_logo).into(view);
    }
    public static void load(ImageView view, File path) {
        Glide.with(view).load(path).error(R.drawable.ic_logo).into(view);
    }
    public static void load(ImageView view, String path,int errIcon) {
        Glide.with(view).load(path).error(errIcon).into(view);
    }
    public static void loadFace(ImageView view, String path) {
        Glide.with(view).load(path).error(R.drawable.ic_face_default).into(view);
    }
